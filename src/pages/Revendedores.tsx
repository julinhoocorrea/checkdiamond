...
import { Plus, Edit, UserX, Phone, Mail, CreditCard, TrendingUp, Settings, Send, Eye, EyeOff, Loader2, CheckCircle } from 'lucide-react';
          ...
          <Alert className={emailResult.success ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50'}>
            ...
            <AlertDescription className={emailResult.success ? 'text-green-800' : 'text-red-800'}>
              ...
              {emailResult.password && (
                <div className="mt-2">
                  <strong>Senha gerada:</strong> <code className="bg-white px-2 py-1 rounded">{emailResult.password}</code>
                </div>
              )}
              {emailResult.emailPreview && (
                <div className="mt-2">
                  ...
                  >
                    ...
                    {showEmailPreview ? 'Ocultar' : 'Ver'} Preview do Email
                  </Button>
                </div>
              )}
            </AlertDescription>
